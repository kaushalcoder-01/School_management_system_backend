...
User.updateUser = async (req) => {
    ...
    let sqlQuery = " UPDATE users SET name='" +req.name+"', email='" + req.email + "', phone='" + req.phone + "', gender='" + req.gender + "', date_of_birth='" + req.date_of_birth + "', address='" + req.address + "',profile_image='" + req.profile_image + "',status='" + req.status + "' WHERE id='" + req.user_id + "'";
...
User.updateParentUser = async (req) => {
    ...
    let sqlQuery = " UPDATE users SET name='"+req.name+"', email='"+req.email+"',phone='"+req.phone+"',address='"+req.address+"' WHERE id='"+req.user_id+"'";
